      ...
      <div className="py-5">
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          >
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our services will navigate the complexities of NDIS plan
              management for you
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Efficient processing of NDIS claims and timely payments.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Strategic planning and oversight to optimise NDIS budgets.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Detailed reports to keep you informed about your financial
                  position.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 flex flex-col-reverse items-center bg-sky-100">
          <div className="md:px-20 md:pl-28 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              We go beyond numbers to provide support and advocacy for our
              clients
            </p>
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Helping clients navigate plan reviews and updates.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                <p className="text-base/relaxed font-medium md:drop-shadow-sm">
                  Advocacy for Additional Supports
                </p>
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Working on behalf of clients to secure necessary additional
                  supports.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          <div className="md:px-20 md:pr-40 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Stay compliant and up-to-date with our compliance and training
              services
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Ensuring your business adheres to NDIS standards and
                  regulations.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Training your team on NDIS processes and compliance
                  requirements.
                </p>
              </div>
            </div>
            ...
            <div className="md:p-10 px-7 pb-10">
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Our team has extensive experience and expertise in NDIS plan
                    management.
                  </p>
                </div>
              </div>
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    We understand the importance of client satisfaction and
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Count on us for accurate, timely, and confidential NDIS plan
                    management services.
                  </p>
                </div>
              </div>
