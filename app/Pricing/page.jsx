    ...
    <div>
      ...
      <div className='py-5'>
        <div className='flex flex-col text-center justify-center bg-sky-50 pt-24 pb-12'>
          ...
          We make our bookkeeping services transparent and fair. You decide how many hours and when you need us.
          </p>
        ...
        <Container>
          <div className='grid grid-rows-11'>
            <div className='border border-black text-center bg-sky-700 text-white text-base md:text-lg font-normal md:text-base md:font-bold mx-10'>IF TOTALS MORE THAN 8 HOURS PER MONTH
            </div>
          ...
          <div className='grid grid-rows-11 pt-2'>
            <div className='border border-black text-center bg-sky-700 text-white text-base md:text-lg font-normal md:text-base md:font-bold mx-10'>IF TOTALS LESS THAN 8 HOURS PER MONTH
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-bold text-sky-700'>
              <p className='border-r border-black'>Weekly Hours</p>
              <p>Bookkeeping Hourly Rate</p>
          ...
          <div className='grid grid-rows-11 pt-2'>
            ...
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>Individual / Sole Trader Income Tax Return - starts at</p>
              <p>$145.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>Partnership Income Tax Return - starts at</p>
              <p>$450.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>Company / Trust Income Tax Return - starts at</p>
              <p>$750.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>Sole Trader / Company BAS - starts at</p>
              <p>$150.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>Consultation - 1st Hour</p>
              <p>$170.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>Consultation - Additional Hour</p>
              <p>$200.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>Company Registeration  - starts at</p>
              <p>$475.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>ABN / TFN Registeration</p>
              <p>$125.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>ACNC Applications </p>
              <p>$1,500.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>Government Grants Application</p>
              <p>$1,450.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-100'>
              <p className='border-r border-black text-start pl-5'>Court Representations - Per Hour</p>
              <p>$150.00</p>
            </div>
            <div className='grid grid-cols-2 text-center gap-0 mx-10 border-l border-r border-b border-black text-base md:text-lg font-normal text-gray-800 bg-gray-300'>
              <p className='border-r border-black text-start pl-5'>Income Confirmation Letter</p>
              <p>$125.00</p>
            </div>
          </div> 
