      ...
      <div className="py-5">
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          >
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our comprehensive services will navigate the complexities of your
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Helping you identify relevant government grants aligned with
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Crafting compelling grant applications that highlight your
                  organisation's strengths and objectives.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Strategic financial planning to align your budget with grant
                  requirements.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 flex flex-col-reverse items-center bg-sky-100">
          <div className="md:px-20 md:pl-28 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Stay compliant and fulfill reporting obligations seamlessly with
              our assistance
            </p>
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Ensuring your organisation meets all stipulated grant
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Providing support in compiling and submitting accurate and
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          <div className="md:px-20 md:pr-40 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Optimise your grant-seeking strategy with our strategic planning
              services
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Tailoring a comprehensive strategy to maximize your chances of
                  grant success.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Empowering your team with the knowledge and skills needed for
            ...
            <div className="md:p-10 px-7 pb-10">
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Our team brings extensive experience in successfully
                    securing government grants across various industries.
                  </p>
                </div>
              </div>
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    We understand that each organisation is unique. Our services
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    We are dedicated to helping your organisation thrive through
                    successful grant applications.
                  </p>
                </div>
              </div>
