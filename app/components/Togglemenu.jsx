            ...
            <NavigationMenu.Root>
              <NavigationMenu.List className=" list-none">
                ...
                <NavigationMenu.Item>
                  <Link
                    href="/Contact"
                    className="px-5 m-5 w-fit text-sm font-medium leading-none border-sky-700 border-solid border rounded-full text-sky-700 hover:text-white h-10 hover:bg-sky-700 text-white-100 flex items-center justify-center"
                  >
                    Get In Touch
                  </Link>
                </NavigationMenu.Item>
