  ...
  return (
    <div>
      ...
      <div className="flex justify-between h-10 items-center pt-5 pl-5">
        ...
        <button
          aria-label="Toggle"
          className="flex text-sky-700 bg-sky-50 justify-center w-12 h-14 pt-5"
          onClick={toggleDiv}
        >
          ...
          <div className="">
            <NavigationMenu.Root>
              <NavigationMenu.List className=" list-none">
                <NavigationMenu.Item>
                  ...
                  <NavigationMenu.Content>
                    <ul className="bg-sky-50 bg-opacity-100 text-black mt-2 w-fit">
                      {items.map((item) => (
                        <ListItem
                          className="transition delay-150 duration-300 ease-in-out text-sm ml-5"
                          title={item.title}
                          href={item.href}
                        ></ListItem>
                      ))}
                ...
                <NavigationMenu.Item>
                  <Link href="/Contact">
                    <button className="px-5 m-5 w-fit text-sm font-medium leading-none border-sky-700 border-solid border rounded-full text-sky-700 hover:text-white h-10 hover:bg-sky-700 text-white-100 flex items-center justify-center">
                      Get In Touch
                    </button>
                  </Link>
                </NavigationMenu.Item>
