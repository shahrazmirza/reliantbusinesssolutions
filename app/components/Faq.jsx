        ...
        <div className="px-7 md:grid md:gap-4">
          ...
          >
            ...
            <p className="text-lg/snug md:text-xl/snug font-normal  text-gray-500 -mt-5 md:mt-4">
              Explore responses to frequently asked questions about tax returns,
              small business matters, and financial planning from our team of
          ...
          <div className="md:flex md:text-start text-center justify-center">
            ...
            <span> </span>
            <Link
              className="text-xl/snug font-normal text-sky-700"
              href="/Contact"
            >
              Contact Us
            </Link>
