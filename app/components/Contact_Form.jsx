...
export const ContactForm = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/index.jsx', {
        method: 'POST',
        body: JSON.stringify({
          firstName,
          lastName,
    ...
    <Container>
      <div className='flex flex-col-reverse md:flex md:flex-row w-full px-7'>
        <div className='flex flex-col md:w-2/6'>
          <p className='text-lg/loose font-normal md:text-xl/loose md:font-normal text-gray-500'>Call us</p>
          <div className='flex items-center'>
            <div className='text-sky-700 leading-10 pr-1'>
              <MdLocalPhone />
            </div>
            <p className='text-l/snug font-normal text-sky-700 leading-10'>0403 320 350</p>
          </div>
            ...
            <div className='flex items-center'>
              ...
              <p className='text-l/snug font-normal text-sky-700 leading-10'>0411 456 467</p>
            </div>
            ...
            <div className='flex items-center'>
              ...
              <p className='text-l/snug font-normal text-sky-700 leading-10'>info@reliantbusinesssolutions.com.au</p>
            </div>
            ...
            <div className="flex items-start text-base/loose font-normal pt-5 mb-4">
              <label>
                <input
                  ...
                  required
                />
                <span className='pl-1'>By providing your phone number, you agree to receive text messages from</span> <span className='font-bold'>Reliant Business Solutions</span> subject to our <Link className='text-sky-700' href='/Privacy-Policy'>privacy policy</Link>.
              </label>
            </div>
