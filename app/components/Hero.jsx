        ...
        <Container>
          <div className="md:grid md:grid-cols-2 md:justify-center md:items-center md:gap-x-20 md:px-10 md:pt-20 md:py-16 px-7">
            <div>
              ...
              >
                At Reliant, discover a wide array of personal and business
                accounting services catering to clients nationwide. We take
                pride in delivering honest advice, valuable feedback, and
                effective solutions to address even the most complex accounting
                needs.
              </motion.p>
              <motion.div
                variants={{
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col">
                <div className="text-base font-medium">Protect Financials</div>
            ...
            >
              ...
              <div className="flex flex-col">
                <div className="text-base font-medium">Expert Advice</div>
                <p className="text-sm font-medium text-gray-500">
                  The top advisors for you
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="flex flex-col">
                <div className="text-base font-medium">Insured Business</div>
                <p className="text-sm font-medium text-gray-500">
                  Fully covered business
                </p>
              </div>
            </motion.div>
          </motion.div>
