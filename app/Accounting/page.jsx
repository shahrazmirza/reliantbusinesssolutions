      ...
      <div className="py-5">
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          >
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our specialised business startup accounting services are here to
              help you
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Expert assistance in choosing the right business structure for
                  your needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Tailored financial strategies to set your business on the path
                  to success.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Seamless registration for all necessary tax obligations.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="md:grid md:grid-cols-2 flex flex-col-reverse items-center bg-sky-100">
          <div className="md:px-20 md:pl-28 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our bookkeeping services will keep your financial records in order
            </p>
            <div className="flex px-4 pt-4">
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Ensuring your bank statements align with your financial
                  records.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Customised reports to help you make informed business
                  decisions.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          <div className="md:px-20 md:pr-40 p-7">
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              We're more than just numbers. Reliant Business Solutions offers
              ongoing support to help your business thrive
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Regular analysis of your financial data to identify trends and
                  opportunities.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Ensuring your business meets all tax obligations, leaving you
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Expert advice to guide your business through every stage of
                  growth.
                </p>
              </div>
            </div>
            ...
            <div className="md:p-10 px-7 pb-10">
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    We specialise in assisting startups, providing the expertise
                    needed to navigate the initial challenges.
                  </p>
                </div>
              </div>
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Your business is unique, and so are our services. We tailor
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Trust in our team of professionals to deliver accurate,
                    timely, and confidential services.
                  </p>
                </div>
              </div>
