      ...
      <div className="py-5">
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-50">
          ...
          >
            ...
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our seasoned tax professionals are here to guide you
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Precise preparation of your individual tax returns.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Strategic planning to optimise your financial position and
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Comprehensive assistance with estate and inheritance tax
                  matters.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 flex flex-col-reverse items-center bg-sky-100">
          <div className="md:px-20 md:pl-28 p-7">
            <p className="text-base/relaxed font-normal text-gray-500 text-center md:drop-shadow-sm pt-5">
              Our Services
            </p>
            <p className="text-2xl/relaxed md:text-3xl/relaxed font-semibold md:drop-shadow-sm">
              Tailored Business Tax Services––
            </p>
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Our team specialises in providing tailored tax services for
              businesses
            </p>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Timely and precise preparation of business tax returns.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Ensuring your business stays compliant with ever-evolving tax
                  regulations.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Proactive planning to help your business achieve its financial
                  goals.
                </p>
              </div>
            </div>
        ...
        <div className="md:grid md:grid-cols-2 items-center bg-gray-100">
          ...
          <div className="md:px-20 md:pr-40 p-7">
            ...
            <p className="text-2xl/relaxed md:text-3xl/relaxed font-semibold md:drop-shadow-sm">
              Expert Consultancy & Advisory––
            </p>
            <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
              Consultancy services to help individuals and businesses make
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Expert guidance on financial matters, tailored to your unique
                  circumstances.
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Developing strategies to optimise your tax position and
            ...
            <div className="flex px-4 pt-4">
              ...
              <div className="pl-4">
                ...
                <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                  Advocating for clients in dealings with tax authorities,
                  ensuring compliance and resolution.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="md:p-10 px-7 pb-10">
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Our team comprises seasoned tax professionals with a wealth
                    of experience in tax planning, preparation, and advisory
                    services.
                  </p>
                </div>
              </div>
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    We understand that each client is unique. Our approach is
                    personalised to meet your specific needs and goals.
                  </p>
                </div>
              </div>
              ...
              <div className="flex px-4 pt-4">
                ...
                <div className="pl-4">
                  ...
                  <p className="text-base/relaxed font-normal text-gray-500 md:drop-shadow-sm">
                    Trust is the foundation of our client relationships. You can
                    rely on us for accuracy, timeliness, and confidentiality.
                  </p>
                </div>
              </div>
